...
// Связанные записи обм_Приемники_ЗагруженныеПакетыДанных - только по пакетам этого сообщения.
//
// Параметры:
//  пСсылка - СправочникСсылка.обм_ВходящиеСообщения
//
// Возвращаемое значение:
//  Булево - Истина, если зафиксировано; Ложь при откате
//
Функция УдалитьСообщение(пСсылка) Экспорт
	...
	Исключение
		...
		общ.Ошибка_ВЖурналРегистрации(
			обм.ИмяСобытияЖурналаРегистрации("ОчисткаОчереди"),
			ИнформацияОбОшибке(),
			пСсылка);
		Возврат Ложь;
