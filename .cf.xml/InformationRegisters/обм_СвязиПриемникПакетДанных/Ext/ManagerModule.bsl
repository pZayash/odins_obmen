...
Процедура Связать(пПриемник, пПакетДанных, пОбработчикЗагрузкиДанныхЗаполнения) Экспорт
	...
	// Зафиксировать заполненного приемника в регистре
		...
		|ИЗ
		|	пакетДанных КАК пд
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.обм_СвязиПриемникПакетДанных.СрезПоследних(, Приемник = &пПриемник) КАК СвязьПП
		...
		запись = РегистрыСведений.обм_СвязиПриемникПакетДанных.СоздатьМенеджерЗаписи();
