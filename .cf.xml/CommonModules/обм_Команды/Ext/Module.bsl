...
// Если есть подсистема БПС, дописать вызов методов этого модуля в соответствующие методы модуля
// ПодключаемыеКомандыПереопределяемый
#Область БПС_ПодключаемыеКоманды
...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	Вид.Имя         = обм_Лит.ИмяПодсистемы();
	Вид.ИмяПодменю  = Метаданные.ГруппыКоманд.обм_КоманднаяПанельФормы.Имя;
	Вид.Заголовок   = Метаданные.ГруппыКоманд.обм_КоманднаяПанельФормы.Синоним;
	Вид.Порядок     = 99;
	Вид.Картинка    = БиблиотекаКартинок.Обновить;
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	Если ПравоДоступа("Чтение", Метаданные.Справочники.обм_ПакетыДанных) Тогда
		
		// ПакетыДанных_Сравнить
		Команда = Команды.Добавить();
		Команда.Вид = обм_Лит.ИмяПодсистемы();
		Команда.Идентификатор = "ПакетыДанных_Сравнить";
		Команда.Представление = "Сравнить пакетры данных";
		Команда.Важность = "Обычное";
		Команда.ОтображениеКнопки = ОтображениеКнопки.Текст;
		Команда.Картинка = Неопределено;
		Команда.ТипПараметра = Новый ОписаниеТипов("СправочникСсылка.обм_ПакетыДанных");
		Команда.ФункциональныеОпции = "";
		Команда.ИзменяетВыбранныеОбъекты = Ложь;
		Команда.РежимЗаписи = "Записывать";
		Команда.Обработчик = "обм_КомандыКлиент.ПакетыДанных_Сравнить";
		Команда.МножественныйВыбор = Истина;
		Команда.ЕстьУсловияВидимости = Ложь;
			
	КонецЕсли; // Если ПравоДоступа("Чтение", Метаданные.Справочники.обм_ПакетыДанных)
	
КонецПроцедуры

#КонецОбласти // БСП_ПодключаемыеКоманды
