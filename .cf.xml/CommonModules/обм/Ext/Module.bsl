...
Процедура Получение_ФоновоеЗадание() Экспорт
	...
	метаЗадания = Метаданные.РегламентныеЗадания.обм_Получение_2_ОбработатьПакетыДанныхВходящихСообщений;
...
Процедура Отправка_ИсходящиеСообщения_Создать() Экспорт
	...
	Пока Истина Цикл
		...
		Пока выборка.Следующий() Цикл
			...
			РегистрыСведений.обм_Измененные.КОтправке(выборка.Ссылка, выборка.ВерсияДанных);
...
Процедура Получение_1_ИзвлечьПакетыДанныхИзВходящихСообщений() Экспорт 
...
Процедура Получение_2_ОбработатьПакетыДанныхВходящихСообщений() Экспорт 
