...
Функция ТабличныйДокумент_ИменаПараметров(	пТабДок, пЗаполнениеТекстКакШаблон = Ложь, 
											пТегСлева = "[", пТегСправа = "]") 				Экспорт
...
КонецФункции 
	...
	Функция ОбластьТабличногоДокумента_ИменаПараметров(	пЯчейка, пЗаполнениеТекстКакШаблон = Ложь, 
														пТегСлева = "[", пТегСправа = "]") 
		...
		ИначеЕсли 		пЯчейка.Заполнение = ТипЗаполненияОбластиТабличногоДокумента.Шаблон 
					Или пЗаполнениеТекстКакШаблон Тогда
