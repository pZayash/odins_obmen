...
Функция Документ_Обработать(ДокументСсылка, ВидОбработки) Экспорт
	...
	КорневойТипКонфигурации = КорневойТипКонфигурации(ДокументСсылка);
...
Функция Документы_СортироватьПоДате(пДокументыСсылки, ЗНАЧ стрНаправлениеСортировки = "ВОЗР") Экспорт
	
	Проверка_Тип(пДокументыСсылки, "Массив");
	...
	Для Каждого ДокументСсылка Из пДокументыСсылки Цикл
...
Функция Документы_ВидОбработки_Представление(ВидОбработки) Экспорт
...
Функция Коллекция_ИзЗначения(пЗначение) Экспорт 
...
Функция Коллекция_РазвернутьСсылки(пКоллекция, Знач пУровень, Знач пИсключаяСвойства = Неопределено) Экспорт
	...
	коллекцияИсключаемых = Коллекция_ИзЗначения(пИсключаяСвойства);
	...
	ссылкаИзКоллекции = общ.Ссылка_ИзКоллекции(пКоллекция);
...
Функция Ссылка_ИзКоллекции(пКоллекция) Экспорт 
	...
	Если естьНавигационнаяСсылка Тогда	
		ссылкаРезультат = общ.Ссылка_ИзНавигационнойСсылки(навигационнаяСсылка); 
...
//
Функция Ссылка_ИзНавигационнойСсылки(пНавигационнаяСсылка) Экспорт
...
Функция КоллекцияПредопределенныхВариантовОтчетов()
	...
	Результат.Колонки.Добавить("Наименование", общ.ОписаниеТиповСтроки());
	Результат.Колонки.Добавить("Описание", общ.ОписаниеТиповСтроки());
	...
	Результат.Колонки.Добавить("Тип", общ.ОписаниеТиповСтроки());
	...
	Результат.Колонки.Добавить("КлючЗамеров", общ.ОписаниеТиповСтроки());
