...
Функция ПримечаниеОЗагрузке() Экспорт
	...
	тестПримечания = СтрСоединить(заполненныеПримечания, Символы.ПС);
	
	Возврат тестПримечания;
...
Функция Приемник_Записать(пПриемникОбъект, пПакетДанных)
	...
	пПриемникОбъект.ДополнительныеСвойства.Вставить("КатегорияОтправителя", пПакетДанных.КатегорияОтправителя);
	пПриемникОбъект.ДополнительныеСвойства.Вставить("ИдентификаторОтправителя", пПакетДанных.ИдентификаторОтправителя);
