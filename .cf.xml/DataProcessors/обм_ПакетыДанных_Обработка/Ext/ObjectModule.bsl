...
Функция Приемник_Записать(пПриемникОбъект, пПакетДанных, пОбработчик)
	...
	РегистрыСведений.обм_СвязиПриемникПакетДанных.Связать(приемникСсылка, пПакетДанных, обработчикСсылка);
	
КонецФункции

Функция Приемник_ЗаполненБолееНовымиДанными(пПакетДанных, пПриемникСсылка)
	...
	|	КОНЕЦ КАК Результат
	|ИЗ
	|	РегистрСведений.обм_СвязиПриемникПакетДанных.СрезПоследних(, Приемник = &Приемник) КАК ПоследнееЗаполнение,
