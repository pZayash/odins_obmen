...
Функция Приемник_Записать(пПриемникОбъект, пПакетДанных)
	...
	пПриемникОбъект.ДополнительныеСвойства.Вставить("КатегорияОтправителя", пПакетДанных.Категория);
	пПриемникОбъект.ДополнительныеСвойства.Вставить("ИдентификаторОтправителя", пПакетДанных.Идентификатор);
