...
Процедура УправлениеДиалогом()
	...
	Если Элементы.ФормаПереключитьРегламентное.Видимость Тогда
		регламентное1 = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_ДанныеЗаполнения_Создать);
...
Процедура ПереключитьРегламентноеНаСервере()
	...
	регламентное1 = 
		РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_ДанныеЗаполнения_Создать);
	регламентное2 = 
