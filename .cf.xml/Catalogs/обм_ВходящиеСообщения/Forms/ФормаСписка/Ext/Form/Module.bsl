...
Процедура УправлениеДиалогом()
	...
	Если Элементы.ФормаПереключитьРегламентное.Видимость Тогда
		регламентное1 = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_СоздатьДанныеЗаполнения);
		регламентное2 = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_ОбработатьДанныеЗаполнения);
