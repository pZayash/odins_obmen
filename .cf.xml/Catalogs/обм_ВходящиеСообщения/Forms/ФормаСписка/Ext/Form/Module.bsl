...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если ТипЗнч(Поле) = Тип("ПолеФормы") И Поле.Имя = "Приемник" Тогда
...
Процедура УправлениеДиалогом()
	...
	Если Элементы.ФормаПереключитьРегламентное.Видимость Тогда
		регламентное1 = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_1_ИзвлечьПакетыДанныхИзВходящихСообщений);
		регламентное2 = РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_ВходящиеСообщения_Обработать);
...
Процедура ПереключитьРегламентноеНаСервере()
	...
	регламентное1 = 
		РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_1_ИзвлечьПакетыДанныхИзВходящихСообщений);
	регламентное2 = 
		РегламентныеЗадания.НайтиПредопределенное(Метаданные.РегламентныеЗадания.обм_Получение_ВходящиеСообщения_Обработать);
