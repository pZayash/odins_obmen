...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ДанныеЗаполнения.Параметры.УстановитьЗначениеПараметра("ВходящееСообщение", Объект.Ссылка);
	
КонецПроцедуры

&НаКлиенте
Процедура ДанныеЗаполненияВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	
	Если Поле = Элементы.ДанныеЗаполненияПриемник Тогда
...
Асинх Процедура ВходящееСообщение_СохранитьВФайл(Команда)
	...
	Файл_Имя = обм.ВходящееСообщение_Параметр_Значение_Получить(Объект.Ссылка, "Файл_Имя");
	Файл_Расширение = обм.ВходящееСообщение_Параметр_Значение_Получить(Объект.Ссылка, "Файл_Расширение");
	Content_type = обм.ВходящееСообщение_Параметр_Значение_Получить(Объект.Ссылка, "Content-Type");	
