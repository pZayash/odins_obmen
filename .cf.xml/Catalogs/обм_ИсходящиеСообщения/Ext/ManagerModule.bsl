...
Процедура ЗарегистрироватьКОтправке(пИсходящиеСообщения) Экспорт 
	...
	проверяемыйТип = Тип("СправочникСсылка.обм_ИсходящиеСообщения");
	
	общ.Проверка_Тип(пИсходящиеСообщения, проверяемыйТип);
	
	исходящиеСообщения = общ.Массив_ПоЗначению(пИсходящиеСообщения, проверяемыйТип);
