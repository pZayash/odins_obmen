...
Функция ОбработчикОбъект(пОбработчикСсылка) Экспорт
	...
	УстановитьПривилегированныйРежим(Истина);
		...
		ХранилищеОбщихНастроек.Сохранить(ИмяНастроекСеанса(), внешняяОбработка.ИспользуемоеИмяФайла, пОбработчикСсылка);
...
Функция НайтиСсылку(пПараметрПоиска) Экспорт
	...
	ИначеЕсли ЭтоВнешняяОбработкаОтчет(пПараметрПоиска) Тогда
...
Функция СсылкаПоОбъектуВнешнейОбработки(пВнешняяОбработкаОбъект)
	...
	спрОбработчикСсылка = 
		ХранилищеОбщихНастроек.Загрузить(ИмяНастроекСеанса(), пВнешняяОбработкаОбъект.ИспользуемоеИмяФайла);
